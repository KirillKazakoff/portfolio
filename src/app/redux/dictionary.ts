const eng = {
    ...
    skills: {
        ...
        list: [
            ...
            'React, React-Router',
            'Redux',
            'Understanding of protocol HTTP/HTTPS, hands-on experience relating to interaction with server API',
...
const ru: ContentT = {
    ...
    skills: {
        ...
        list: [
            ...
            'React, React-Router',
            'Redux',
            'Протокол HTTP/HTTPS, опыт взаиодействия с серверным API',
